...
# 定义源模型路径和转换后的目标路径
ORIGINAL_MODEL_PATH="/workspace/opt/models/plfactory-15b-plforge-sft-v6-cp5"
FIXED_MODEL_PATH="/workspace/opt/models/plfactory-15b-plforge-sft-v6-cp5-bf16"
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='plfactory-plforge-15b-rl-train-1' \
